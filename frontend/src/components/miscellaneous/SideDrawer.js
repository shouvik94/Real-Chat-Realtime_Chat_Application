    ...
    <React.Fragment>
      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='red.600' onClick={onOpen} color="white"
            _hover={{ background: "purple.800", color:"green.400" }} _active={{ background: "purple.800", color:"green.400" }}>
        ...
        <Text fontSize="3xl" fontFamily="Work sans bold" fontWeight='bold' color="red" >
          REAL-CHAT
        </Text>
        ...
        <div>
          <Menu>
            <MenuButton p={1}>
              <NotificationBadge
                ...
                effect={Effect.SCALE}
              />
               <BellIcon fontSize="3xl" m={1} color="blue.700"/>
            </MenuButton>
            <MenuList pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="red.700"  rightIcon={<ChevronDownIcon/>}  
